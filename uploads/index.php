...
switch ($action) {
    case 'upload':
        ...
        if ($imageCheck) {
            $message = '<p class="failure">An image by that name already exists.</p>';
        } elseif (empty($invId) || empty($imgName)) {
            $message = '<p class="failure">You must select a vehicle and image file for the vehicle.</p>';
        } else {
            ...
            if ($result) {
                ...
                $message = '<p class="failure">Sorry, the upload failed.</p>';
            }
        }
    ...
    case 'delete':
        ...
        if ($remove) {
            ...
            $message = "<p class='failure'>$filename was NOT deleted.</p>";
        }
    ...
    default:
        ...
        if (count($imageArray)) {
            ...
            $imageDisplay = '<p class="failure">Sorry, no images could be found.</p>';
        }
