...
function buildInventoryList(data) { 
    ...
    let dataTable = '<thead>'; 
    dataTable += '<tr><th id="invD">Vehicle Name</th><td>&nbsp;</td><td>&nbsp;</td></tr>'; 
    dataTable += '</thead>'; 
    ...
    data.forEach(function (element) { 
     ...
     dataTable += `<td><a id="invDbody" href='/phpmotors/vehicles?action=mod&invId=${element.invId}' title='Click to modify'>Modify</a></td>`; 
     dataTable += `<td><a id="invDbody" href='/phpmotors/vehicles?action=del&invId=${element.invId}' title='Click to delete'>Delete</a></td></tr>`; 
    }) 
    dataTable += '</tbody>'; 
